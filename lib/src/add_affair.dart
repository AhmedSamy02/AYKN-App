...
import 'package:login_app/src/annoucment_add.dart';
import 'package:login_app/src/view_affair.dart';
import 'package:shared_preferences/shared_preferences.dart';

class add_affair extends StatefulWidget {
  @override
  State<add_affair> createState() => _add_affairState();
}
getPref() async {
  ...
  void initState() {
    ...
    annoucmnets = [
      [
        ...
        'In commoration of the 74th Indonesian Independence Dat, the management will hold an inter-division competition which will be held on Friday, August 16, 2019. The competition that will be held are tug-war race, cracker-eating contest, and futsal competition. We are waiting for each division to send the representative names to HR division no later than Wednesday, August 14, 2019'
      ],
      [
